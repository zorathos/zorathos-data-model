...
@AllArgsConstructor
@Builder
@JsonPropertyOrder({"aircraftId", "messageTime", "satelliteGuidanceTime", "localTime", "messageSequenceNumber", "trueAngleOfAttack", "machNumber", "normalLoadFactor", "indicatedAirspeed", "fieldElevation", "radioAltitude", "remainingFuel", "scenario", "manualRespawn", "parameterSettingStatus", "encryptionStatus"})
