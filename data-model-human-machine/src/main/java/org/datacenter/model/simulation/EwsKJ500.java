...
@AllArgsConstructor
@Builder
@JsonPropertyOrder({"aircraftId", "messageTime", "satelliteGuidanceTime", "localTime", "messageSequenceNumber", "azimuthStartAngle", "sectorReference", "sectorType", "sectorNumber", "actionCode", "azimuthEndAngle"})
