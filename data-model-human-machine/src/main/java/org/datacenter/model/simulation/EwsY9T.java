...
@AllArgsConstructor
@Builder
@JsonPropertyOrder({"aircraftId", "messageTime", "satelliteGuidanceTime", "localTime", "messageSequenceNumber", "jammingAzimuth", "jammingFrequencyCount", "jammingType", "jammingBand", "jammingDirection", "jammingStatus", "jammingElevation", "jammingStartFrequency", "jammingEndFrequency"})
