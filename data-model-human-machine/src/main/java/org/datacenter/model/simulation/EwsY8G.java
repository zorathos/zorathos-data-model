...
@AllArgsConstructor
@Builder
@JsonPropertyOrder({"aircraftId", "messageTime", "satelliteGuidanceTime", "localTime", "messageSequenceNumber", "xBandJammingElevation", "cBandJammingElevation", "cBandJammingAzimuth", "sBandJammingElevation", "sBandJammingAzimuth", "lBandJammingElevation", "lBandJammingAzimuth", "uBandJammingAzimuth", "jammingStatus", "xBandJammingAzimuthAngle"})
