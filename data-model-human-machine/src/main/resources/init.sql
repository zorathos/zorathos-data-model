...
# ---------------------------------------- 生理数据表 ----------------------------------------
#     physiological
CREATE TABLE IF NOT EXISTS physiological.ecg
(
    ...
    respiration_rate        DOUBLE COMMENT '呼吸率(Resp)',
    temperature             FLOAT COMMENT '体温（T)',
    blood_oxygen_saturation INT COMMENT '血氧饱和度(T_SpO2）',
    INDEX idx_sortie_number (sortie_number)
) COMMENT ='心电数据';
...
(
    ...
    hips_timestamp                           BIGINT COMMENT 'Hips_Timestamp',
    ...
    joint_tag_spine_timestamp                BIGINT COMMENT 'JointTag_Spine_Timestamp',
    ...
    joint_tag_spine1_timestamp               BIGINT COMMENT 'JointTag_Spine1_Timestamp',
    ...
    joint_tag_spine2_timestamp               BIGINT COMMENT 'JointTag_Spine2_Timestamp',
    ...
    joint_tag_neck_timestamp                 BIGINT COMMENT 'JointTag_Neck_Timestamp',
    ...
    joint_tag_neck1_timestamp                BIGINT COMMENT 'JointTag_Neck1_Timestamp',
    ...
    joint_tag_right_shoulder_timestamp       BIGINT COMMENT 'JointTag_RightShoulder_Timestamp',
    ...
    joint_tag_right_arm_timestamp            BIGINT COMMENT 'JointTag_RightArm_Timestamp',
    ...
    joint_tag_right_fore_arm_timestamp       BIGINT COMMENT 'JointTag_RightForeArm_Timestamp',
    ...
    joint_tag_right_hand_timestamp           BIGINT COMMENT 'JointTag_RightHand_Timestamp',
    ...
    joint_tag_right_in_hand_index_timestamp  BIGINT COMMENT 'JointTag_RightInHandIndex_Timestamp',
    ...
    joint_tag_right_in_hand_middle_timestamp BIGINT COMMENT 'JointTag_RightInHandMiddle_Timestamp',
    ...
    joint_tag_left_shoulder_timestamp        BIGINT COMMENT 'JointTag_LeftShoulder_Timestamp',
    ...
    joint_tag_left_arm_timestamp             BIGINT COMMENT 'JointTag_LeftArm_Timestamp',
    ...
    joint_tag_left_fore_arm_timestamp        BIGINT COMMENT 'JointTag_LeftForeArm_Timestamp',
    ...
    joint_tag_left_hand_timestamp            BIGINT COMMENT 'JointTag_LeftHand_Timestamp',
    ...
    joint_tag_left_in_hand_index_timestamp   BIGINT COMMENT 'JointTag_LeftInHandIndex_Timestamp',
    ...
    joint_tag_left_in_hand_middle_timestamp  BIGINT COMMENT 'JointTag_LeftInHandMiddle_Timestamp',
    INDEX idx_sortie_number (sortie_number)
) COMMENT ='三维动捕数据';
